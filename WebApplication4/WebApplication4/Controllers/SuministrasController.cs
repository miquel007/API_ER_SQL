...
namespace WebApplication4.Controllers
{
    ...
    public class SuministrasController : ControllerBase
    {
        ...
        {
            var suministra = await _context.Suministros.FindAsync(id);
        ...
        {
            _context.Suministros.Add(suministra);
            try
            {
                await _context.SaveChangesAsync();
            }
        ...
        public async Task<ActionResult<Suministra>> DeleteSuministra(string id)
        {
            ...
            _context.Suministros.Remove(suministra);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Suministros.Any(e => e.id_proveedor == id);
        }
    }
}
